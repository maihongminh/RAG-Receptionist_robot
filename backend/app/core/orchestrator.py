...
class Orchestrator:
    ...
    def _normalize_llm_intent(
        ...
        source_by_intent = {
            ...
            "partner_lab_request_lookup": "auth",
        ...
        elif intent.intent == "partner_lab_request_lookup" and not entities.get("request_query"):
            entities["request_query"] = rule_intent.entities.get("request_query", "")
