...
SELECT count(*) FROM robo_app.account_profiles;
SELECT count(*) FROM robo_app.account_user_roles;
SELECT count(*) FROM robo_app.account_clinic_memberships;
SELECT count(*) FROM robo_app.organizations;
SELECT count(*) FROM robo_app.organization_memberships;
SELECT count(*) FROM robo_app.platform_admins;
